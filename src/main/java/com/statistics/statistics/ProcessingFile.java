...
public class ProcessingFile {
    ...
    public static void CreateJson(TreeMap<String, double[]> statistics, String[] statisticsHeadings) throws IOException {
        ...
        Files.write(Paths.get("C:/Users/Admin/output_statistics.json"), jsonArray.toString().getBytes());
    }
