...
public class ExcelFile {
    ...
    public static void Create(TreeMap<String, double[]> data, String[] statisticsHeadings, String file_output){
        ...
        try (var outputStream = new FileOutputStream(file_output)) {
