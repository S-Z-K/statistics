...
//тестовый класс - для создания json-файла с количеством маркеров
public class JsonProperties {
    public static void main(String[] args) throws IOException {

        String path_save = ""; //имя тестового файла
        CreateJson(path_save);
    }

    
    //генерация тестового файла с количеством маркеров
    public static void CreateJson(String path_save)
            throws IOException {
        ...
        Files.write(Paths.get(path_save), jsonArray.toString().getBytes());
    }
    

    //генерация наименований маркеров
    ...
    //генерация количества "найденных в тексте маркеров"
